                ...
                widget: 'dxButton', location: 'before', options: {
                    type: 'default', text: 'Save', icon: 'check', validationGroup: 'toadd', onClick: function (e) {
                        ...
                        db.DeleteDoc($scope.FDPId, $scope.FlightId, $scope.Type, function () {
                            db.AddDoc({ FDPId: $scope.FDPId, FlightId: $scope.FlightId, Type: $scope.Type, Data: $scope.image_data_url, Date: moment(new Date()).format('YYYY-MMM-DD HH:mm'), IsSynced: false }, function () {
                                $scope.callSave();
