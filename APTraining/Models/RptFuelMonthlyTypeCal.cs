...
namespace APTraining.Models
{
    public partial class RptFuelMonthlyTypeCal
    {
        ...
        public decimal? UsedPerLegDiff { get; set; }
        ...
        public decimal? UsedPerFlightTimeDiff { get; set; }
        ...
        public double? UsedPerWeightToneDistanceDiff { get; set; }
        ...
        public decimal? UsedPerWeightToneBlockTimeDiff { get; set; }
    }
}
